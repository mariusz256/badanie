  ...
  return (
    <div className="HomePage">
      ...
      <p className="text">
        ...
        certyfikowanych testów psychologicznych. Zapraszamy do naszej pracowni w
        Oświęcimiu pod adresem: Wilamowicka 17, 32-600 Rajsko.
      </p>
      <p className="text">
        ...
        transportu i medycyny pracy, powstał pomysł na stworzenie strony naszych
        usług oraz bloga.{" "}
      </p>
      <p className="text">
        ...
        zapraszamy wszystkie osoby, które chcą dowiedzieć się więcej o badaniach
        psychologicznych. Mamy nadzieję że jeśli tu trafiłeś to znajdziesz to
        czego szukasz.
      </p>
      <p className="text">
        Dajemy rękojmie jakości i rzetelności prowadzonych badań
        psychologicznych. Nasza placówka w Rajsku k. Oświęcimia posiada nr
        192/2019 i jest wpisana do rejestru Marszałka Wojewódzkiego Województwa
        Małopolskiego.
      </p>
    </div>
  );
